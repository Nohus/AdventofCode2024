...
import adventofcode2024.generated.resources.box_wide_marked
import adventofcode2024.generated.resources.box_wide_marked2
...
import day15.visualisation.ViewModel2.State
import day15.visualisation.ViewModel2.Tile.BoxLeft
import day15.visualisation.ViewModel2.Tile.BoxRight
import day15.visualisation.ViewModel2.Tile.Empty
import day15.visualisation.ViewModel2.Tile.Wall
...
fun main() = application {
    Window(
        state = WindowState(width = 1700.dp, height = 800.dp),
        onCloseRequest = ::exitApplication,
        title = "Advent of Code 2024: Day 15 Part 2",
        icon = painterResource(Res.drawable.icon)
    ) {
        val viewModel = remember { ViewModel2() }
            ...
            for (y in 0 until height) {
                for (x in 0 until width) {
                    ...
                    when (val tile = state.grid[point]) {
                        BoxLeft -> {}
                        BoxRight -> Image(
                            painter = painterResource(if (point in state.markedBoxes) Res.drawable.box_wide_marked2 else Res.drawable.box_wide_marked),
                            contentDescription = null,
                            modifier = Modifier
