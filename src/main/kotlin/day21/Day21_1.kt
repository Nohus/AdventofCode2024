...
import day21.DpadKey.ACTIVATE
import day21.DpadKey.DOWN
import day21.DpadKey.LEFT
import day21.DpadKey.RIGHT
import day21.DpadKey.UP
import solve
import utils.Point
...
fun main() = solve { lines ->
    lines.sumOf { line ->
        getPossibleNumpadMoves(line.toList()).minOf { moves ->
            ...
            moves.sumOf { move ->
                getMovesCount(currentPosition, move, level = 1, maxLevel = 2).also { currentPosition = move }
            }
